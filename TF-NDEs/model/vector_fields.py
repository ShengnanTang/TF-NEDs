...
from utils.odefunc import build_fc_odefunc
class FinalTanh_f_custom(nn.Module):
    def __init__(self, input_channels, hidden_channels, hidden_hidden_channels, num_hidden_layers,t_total):
        super(FinalTanh_f_custom, self).__init__()
        
        self.input_channels = input_channels
        self.hidden_channels = hidden_channels
        self.hidden_hidden_channels = hidden_hidden_channels
        self.num_hidden_layers = num_hidden_layers
        self.hidden_dim = [self.hidden_hidden_channels] * (num_hidden_layers + 1)
        self.linears = build_fc_odefunc(dim=self.hidden_channels, hidden_dims=self.hidden_dim, 
                                        out_dim=input_channels * hidden_channels, actfn="leakyrelu", layer_type="concat_te")
